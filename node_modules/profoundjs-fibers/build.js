...
var isNodeOver10 = (parseInt(process.versions.modules) > 64);	//Avoid needing to rebuild separate binaries for Node 10. MD.
var modPath = platform+ '-'+ arch+ '-'+ process.versions.modules+  ((platform === 'linux' && isNodeOver10) ? '-'+ detectLibc.family : '');
